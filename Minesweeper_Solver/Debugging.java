...
public class Debugging {
    public static void main(String[] args) throws IOException, AWTException {
        ...
        BufferedImage image2 = ImageIO.read(new File("Minesweeper_Solver\\imgs\\cell8.png"));
        BufferedImage sample = ImageIO.read(new File("sample.png"));
        System.out.println(compareImage(image, image2));
        enumeratePixels(image2);
        System.out.println();
        displayRGBInt(-8421505);
        displayMouseCoordinates();
        //screenshot(new Rectangle(500, 500), "sample", "png");
        //;
        ImageIO.write(cropImage(sample, 0, 0, 20, 20), "png", new File("cropped" + "." + "png"));
    }
